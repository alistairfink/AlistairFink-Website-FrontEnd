    ...
    return (
      <div className="Home">
        ...
        {this.state.smallScreen && this.state.mobileOpen &&
      	...
      	<div>
      		<div className="Logos">
      			<a className="LogoLink" rel="noopener noreferrer" href="https://github.com/alistairfink" target="_blank"><img src={Github} alt="Alistair's Github"/></a>
      			<a className="LogoLink" rel="noopener noreferrer" href="https://www.linkedin.com/in/alistairfink/" target="_blank"><img src={LinkedIn} alt="Alistair's LinkedIn"/></a>
      			<a className="LogoLink" rel="noopener noreferrer" href="https://drive.google.com/file/d/12KtoofbXqJj4QFBQ4gzA0PMsdmMH5wpj/view?usp=sharing" target="_blank"><img src={Resume} alt="Alistair's Resume"/></a>
      			<a className="LogoLink" rel="noopener noreferrer" href="mailto:alistairfink@gmail.com" target="_blank"><img src={Email} alt="Alistair's Email"/></a>
      		</div>
          <div className={this.state.smallScreen ? "Title-Mobile" : "Title"}>
            ...
            <div className={this.state.smallScreen ? "Title-Text-Mobile" : "Title-Text"}>
              ...
              <p>{"\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0"}</p><p className="Title-Text-Yellow">{"\"App Developer\""}</p><p>,</p><br/>
              <p>{"\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0"}</p><p className="Title-Text-Yellow">{"\"Software Architect\""}</p><p>,</p><br/>
              <p>{"\u00A0\u00A0\u00A0\u00A0\u00A0\u00A0"}</p><p>{`}`}</p><br/>
